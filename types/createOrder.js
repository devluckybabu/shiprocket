        ...
        auth.then((user) => {
            fetch(`https://apiv2.shiprocket.in/v1/external/orders/create/adhoc`, {
                ...
                body: JSON.stringify(Object.assign(Object.assign(Object.assign({ pickup_location,
                    ...
                    payment_method }, priceInfo), pakageInfo), { billing_customer_name: billing_address.firt_name, billing_last_name: billing_address.last_name, billing_address: billing_address.address, billing_address_2: billing_address.address_2, billing_email: billing_address.email, billing_phone: billing_address.phone, billing_city: billing_address.city, billing_state: billing_address.state, billing_country: billing_address.country, billing_pincode: billing_address.pincode, shipping_customer_name: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.firt_name, shipping_last_name: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.last_name, shipping_phone: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.phone, shipping_email: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.email, shipping_address: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.address, shipping_address_2: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.address_2, shipping_city: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.city, shipping_state: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.state, shipping_pincode: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.pincode, shipping_country: shipping_address === null || shipping_address === void 0 ? void 0 : shipping_address.country }))
